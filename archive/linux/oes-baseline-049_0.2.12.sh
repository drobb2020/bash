...
# 
#   DESCRIPTION: Baseline and monitor a new OES server pre and post suggested OES tuning
#
...
#         NOTES: Based on the OES Post Installation Tuning guide v2.4
#        AUTHOR: David Robb (DER), david.robb@microfocus.com
#  CONTRIBUTORS: 
#  ORGANIZATION: Micro Focus
#       CREATED: Mon Jul 09 2012 08:30
#  LAST UPDATED: Sun Jun 19 2016 14:55
#      REVISION: 11
#     SCRIPT ID: 049
# SSC UNIQUE ID: --
#===============================================================================
...
version=0.2.12
sid=049                                         # personal script id number
...
log='/var/log/oes-baseline.log'                 # logging (if required)
...
ndssbin=/opt/novell/eDirectory/sbin             # path to supervisor nds binaries
