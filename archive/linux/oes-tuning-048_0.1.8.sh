...
##############################################################################
#
#    oes2-tuning.sh - OES2 SP3 Post Installation Tuning script
...
# Last updated: Thu May 28 07:55:12 2015 
...
$DIALOG --colors --title "\Zb\Z0LUM configuration" --clear \
		 --backtitle "v$REL OES2 Post Installation Tuning Script" \
		 --msgbox "Linux Uuser Management (LUM) best practices requires that the local server points to itself as the preferred server, whether or not the local server holds a replica." 0 0
...
clear
echo "========================================================================"
echo "V$REL OES2 Post Installation script"
