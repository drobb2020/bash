...
#   LAST UDATED: Mon Mar 12 2018 09:06
#       VERSION: 0.2.17
#     SCRIPT ID: 010
# SSC SCRIPT ID: 00
#===============================================================================
version=0.2.17                                   # version number of the script
sid=010                                          # personal script ID
...
if [ $namcdReturnCode == "0" ]; then
  ...
  logit "namcd restart attempt complete"
	sleep 5
  /usr/sbin/rcnamcdd status &>/dev/null
  namcdReturnCode3=$?
