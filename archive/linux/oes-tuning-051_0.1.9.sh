...
#         USAGE: ./oes-tuning.sh 
# 
#   DESCRIPTION: OES2 SP3 Post Installation Tuning script
#
...
#  LAST UPDATED: Wed Jul 22 2015 09:46
#      REVISION: 9
#     SCRIPT ID: 051
# SSC SCRIPT ID: ---
#===============================================================================
...
version=0.1.9
sid=051                                     # personal script id number
...
log='/var/log/oes-tuning.log'               # logging (if required)
