...
#   LAST UDATED: Thu Mar 15 2018 10:37
#       VERSION: 0.1.7
#     SCRIPT ID: 069
# SSC SCRIPT ID: 00
#===============================================================================
...
maila2="/root/7004526.pdf"                       # mail attachment 2 - how to process cores
#===============================================================================
...
function core_cleaner { 
  ...
  rm -rv $maila1  | tee -a $log
	echo -e ">>> Reseting mail counter to 0" | tee -a $log
  echo "mailed=0" > $mailc | tee -a $log
	echo "mailcounter has been reset to: $(echo $mailc)" | tee -a $log
