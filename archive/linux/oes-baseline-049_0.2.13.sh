...
#   LAST UDATED: Thu Mar 15 2018 11:09
#       VERSION: 0.2.13
#     SCRIPT ID: 049
# SSC SCRIPT ID: 00
#===============================================================================
version=0.2.13                                   # version number of the script
sid=049                                          # personal script ID
...
mfrom=oes-baseline                               # email sender
...
osver=$(cat /etc/SuSE-release | grep VERSION | cut -d " " -f 3) # get OS version
