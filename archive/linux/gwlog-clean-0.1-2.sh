...
##############################################################################
#
#    gwlog_clean-0.1-02.sh - remove hostname and IP Address information from a 
#                            GroupWise POA or MTA log
...
#
##############################################################################
# Date Created: Wed Aug 08 14:10:02 2012 
# Last updated: Thu Jan 10 12:02:23 2013 
...
$DIALOG --help-button --help-label "gpl 3" --colors --title "\Zb\Z0How to exit the script" --clear \
		 --backtitle "V$REL GroupWise Log Cleaner - removes hostname and IP Addresses" \
		 --msgbox "Please make sure all files are unpacked before proceeding. During the question phase you can use ctrl+c, ESC, or the cancel button to exit this script. Once the questions have been answered the script will perform the necessary operations on the log files in the specified directory." 0 0
...
$DIALOG --colors --title "\Zb\Z0Supportconfig Files location" --clear \
		 --backtitle "V$REL GroupWise Log Cleaner - removes hostnames and IP Addresses" \
...
echo "==[GroupWise Log Cleaner V$REL]==================================="
echo "The log file from the GroupWise server $HOST has been cleaned of" 
echo "all hostname and IP Address information, and has been recompressed" 
