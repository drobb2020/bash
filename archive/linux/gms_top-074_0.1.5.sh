...
#   LAST UDATED: Sun Mar 18 2018 11:03
#       VERSION: 0.1.5
#     SCRIPT ID: 074
# SSC SCRIPT ID: 38
#===============================================================================
version=0.1.5                                    # version number of the script
sid=074                                          # personal script ID
uid=38                                           # SSC | RCMP script ID
#===============================================================================
...
mfrom=gms-monitor                                # email sender
email=root                                       # email recipient(s)
log='/var/log/gms_top.log'                       # log name and location (if required)
#===============================================================================
