...
# 
#   DESCRIPTION: Certificate renewal script for the CENTRAL tree RCMPWF tree, and ATLANTIC Tree
#
...
#  LAST UPDATED: Sun Jun 19 2016 14:47
#      REVISION: 4
#     SCRIPT ID: 048
# SSC UNIQUE ID: 25
#===============================================================================
...
version=0.1.5
sid=048                                         # personal script id number
uid=25                                          # SSC/RCMP script id number
...
log='/var/log/renew-certs.log'                  # logging (if required)
...
pswd=/tmp/pwd.$$.tmp                            # Administrator's password
