...
#   LAST UDATED: Tue Mar 32 2018 07:56
#       VERSION: 0.1.7
#     SCRIPT ID: 015
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.7                                    # version number of the script
sid=015                                          # personal script ID
...
log='/var/log/slpmod-daip.log'                   # log name and location (if required)
...
DA1=                                             # first new DA server ip address
DA2=                                             # second new DA server ip address 
#===============================================================================
