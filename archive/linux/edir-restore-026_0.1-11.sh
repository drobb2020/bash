...
# Last updated: Wed May 27 13:24:01 2015 
...
# Send Report
if { -n $EMAIL ]; then
  echo -e "An eDirectory restore has been performed on $HOST. If you did not perform this restore, please check to find out who did and document the reason. All eDirectory and nici files have been restored to their original versions and locations. This restore does not affect the binary version of the RPM packages for eDirectory or NICI." | mail -s "$HOST eDir Restore Report" $EMAIL
fi
