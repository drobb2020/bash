...
#   LAST UDATED: Sun Mar 18 2018 12:15
#       VERSION: 0.1.6
#     SCRIPT ID: 082
# SSC SCRIPT ID: 00
#===============================================================================
...
log='${lgodir}/smbackup.log'                     # logging (if required)
errlog='${logdir}/smbackup.error.log'            # error log location
bkupdir='/global/data/smbackup'                  # backup destination directory
...
spacewalk_data='/var/spacewalk/packages/1/ /var/spacewalk/db-backup/' # files under /var/spacewalk to backup
#===============================================================================
