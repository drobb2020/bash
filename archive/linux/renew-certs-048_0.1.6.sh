...
#   LAST UDATED: Thu Mar 15 2018 10:49
#       VERSION: 0.1.6
#     SCRIPT ID: 048
# SSC SCRIPT ID: 25
#===============================================================================
version=0.1.6                                    # version number of the script
sid=048                                          # personal script ID
uid=25                                           # SSC | RCMP script ID
#===============================================================================
...
log='/var/log/renew-certs.log'                   # log name and location (if required)
admin=/tmp/adm.$$.tmp                            # administrators account name FQN
pswd=/tmp/pswd.$$.tmp                            # aadministrator's password
