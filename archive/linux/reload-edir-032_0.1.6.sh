...
#   LAST UDATED: Mon Mar 12 2018 09:13
#       VERSION: 0.1.6
#     SCRIPT ID: 032
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.6                                    # version number of the script
sid=032                                          # personal script ID
...
mfrom=reload-ndsd                                # email sender
email=root                                       # email recipient(s)
log='/var/log/reload-edir.log'                   # log name and location (if required)
maxcon=`ncpcon connections 2>/dev/null | sed -ne  "s/.*Connection Slots Allocated\t//pg"` # allocated connection slots
#===============================================================================
