...
# Last updated: Wed Feb 06 14:52:55 2013 
...
if [ -e $NDSCFG ]
		...
		echo | $NDSBIN/ndsrepair --config-file $NDSCFG -P 2>/dev/null | awk 'NR > 9' | sed -e "s/'//g" | sed -e 's/Press ENTER to continue... OR enter q to exit this listing //g' >>$REPORT
		addspace
		sleep 10
