...
#         USAGE: ./slpmod.sh 
# 
#   DESCRIPTION: A script to modify the slp.conf file on a server to include a new scope name
#
...
#  LAST UPDATED: Mon Jul 20 2015 09:28
#      REVISION: 3
#     SCRIPT ID: 014
#===============================================================================
...
version=0.1.3
sid=014                                     # script ID number
ts=$(date +"%b %d %T")                      # general date/time stamp
host=$(hostname)                            # host name of local server
user=$(whoami)                              # user checking routine
email=root                                  # default email value
log='/var/log/slpmod.sh.log'                # logging (if required)
