...
#   LAST UDATED: Tue Mar 13 2018 13:50
#       VERSION: 0.1.15
#     SCRIPT ID: 033
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.15                                   # version number of the script
sid=033                                          # personal script ID
...
mfrom=GroupWise-backup                           # email sender
email=root                                       # email recipient(s)
log='/var/log/gwbackup.log'                      # log name and location (if required)
...
incdir=/root/bin                                 # include this directory
#===============================================================================
