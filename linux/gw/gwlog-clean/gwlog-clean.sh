...
#   LAST UDATED: Tue Mar 13 2018 14:00
#       VERSION: 0.1.5
#     SCRIPT ID: 034
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.5                                    # version number of the script
sid=034                                          # personal script ID
...
mfrom=log-cleaner                                # email sender
email=root                                       # email recipient(s)
log='/var/log/gwlog-clean.log'                   # log name and location (if required)
