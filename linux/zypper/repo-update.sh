...
#   LAST UDATED: Sun Mar 18 2018 11:10
#       VERSION: 0.1.4
#     SCRIPT ID: 056
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.4                                    # version number of the script
sid=056                                          # personal script ID
...
log='/var/log/repo-update.log'                   # log name and location (if required)
oesver=$(cat /etc/novell-release | grep VERSION | awk '{print $NF}') # OES version
