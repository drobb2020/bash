...
#   LAST UDATED: Mon Apr 15 2019 15:16
#       VERSION: 0.2.00
#     SCRIPT ID: 025
# SSC SCRIPT ID: 00
#===============================================================================
version=0.2.00                                   # version number of the script
...
mail_body3() {
fn=$(ls /backup/$host/nici/ | grep $now) 
...
until [ "$selection" = "0" ]; do
  ...
  echo "2   -   Backup NICI files & NICI confiuration files"
