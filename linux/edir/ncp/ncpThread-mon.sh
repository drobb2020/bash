...
#   LAST UDATED: Thu Mar 15 2018 08:08
#       VERSION: 0.1.6
#     SCRIPT ID: 041
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.6                                    # version number of the script
sid=041                                          # personal script ID
...
function mail_body4() { 
echo -e "$ts $host - The Total allocated NDSD threads has hit the max-thread number. This means that the server cannot spawn any more threads at this time. Pleaes investigate the server more closely. You may have to increase the n4u.server.max-threads value to a higher number. The default is 256, and can be set as hight as 512."
}
