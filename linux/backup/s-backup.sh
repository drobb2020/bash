...
#   LAST UDATED: Thu Mar 08 2018 09:39
#       VERSION: 0.1.10
#     SCRIPT ID: 002
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.10                                   # version number of the script
sid=002                                          # personal script ID
...
if [ $L1 = $L3 ]; then
  ...
  echo -e "The Reseach and Development repository was backed up, but there are differences between the source and destination folders. Please investigate." | mail -s "Repository Backup Incomplete" -r $mfrom $email
fi
