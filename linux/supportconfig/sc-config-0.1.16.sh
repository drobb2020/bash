...
#         USAGE: ./sc-config.sh 
# 
#   DESCRIPTION: Configure the server to collect a supportconfig on a daily basis
#
...
if [ -f /usr/lib/supportconfig/header.txt ]; then
  ...
  echo -e "be removed from any information provided to third-party vendors. If this"
  echo -e "supportconfig collection needs to be provided to Micro Focus for additional"
  echo -e "analysis please contact the Micro Focus SSE and ask for a copy of the"
  echo -e "sc-clean.sh script."
