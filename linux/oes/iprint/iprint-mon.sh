...
function mail_body1() {
echo -e "The iPrint Manager IPSMD is not running on: $host. An automatic restart is being attempted now. If this restart fails you will recieve a second email."
}
...
function mail_body3() { 
echo -e "The iPrint Driver Store (IDSD) is not running on: $host. An automatic restart is being attempted now. If this restart fails you will recieve a second email."
}
