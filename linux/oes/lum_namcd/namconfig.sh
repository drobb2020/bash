...
# 1.2 		Eric Ladouceur		2017-05-05		-Fix conditions when server hold more
#								 than 1 replica
# 1.3		Eric Ladouceur		2017-07-11		-Fix conditions for server holding a replica
# 1.4		Eric Ladouceur		2017-07-19		-Add persistant search setting check
