...
#   LAST UDATED: Thu Mar 15 2018 10:13
#       VERSION: 0.1.9
#     SCRIPT ID: 068
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.9                                    # version number of the script
sid=068                                          # personal script ID
...
maila1="/root/cores.txt"                         # mail attachment 1 - details about the cores
maila2="/root/7004526.pdf"                       # mail attachment 2 - how to handle cores
cronfreq=8                                       # how often (once every X hours) to run 
                                                 # the core-checker script
#===============================================================================
