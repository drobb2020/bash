...
#===============================================================================
#
#          FILE: clear_attributes.sh
# 
#         USAGE: ./clear_attributes.sh
# 
...
#  LAST UPDATED: Tue Feb 16 2021 17:14
#       VERSION: 0.1.2
#     SCRIPT ID: 
# SSC SCRIPT ID: 00
#===============================================================================
...
log='/var/log/clear_attributes.log'         # log name and location (if required)
nsssbin=/opt/novell/nss/sbin                # path to NSS binaries
nssbase=/media/nss                          # path to NSS volume
#===============================================================================
...
echo "(in uppercase) you would like to clear"
...
for d in $DIRS
  do
    $nsssbin/attrib -r ${nssbase}/"$vol"/"${d}" -c=di,ri,ro | tee -a $log
  done
