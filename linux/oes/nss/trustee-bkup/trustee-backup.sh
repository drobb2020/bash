...
#   LAST UDATED: Thu Mar 15 2018 08:49
#       VERSION: 0.1.5
#     SCRIPT ID: 046
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.5                                    # version number of the script
sid=046                                          # personal script ID
...
log='/var/log/trustee-backup.log'                # log name and location (if required)
#===============================================================================
...
# E-mail results
if [ -n "$email" ]; then
  mail_body1 | mail -s "NSS Trustee Backup Report for $hsot" -r $mfrom $email
fi
