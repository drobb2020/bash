...
#   LAST UDATED: Thu Mar 15 2018 08:24
#       VERSION: 0.1.6
#     SCRIPT ID: 043
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.6                                    # version number of the script
sid=043                                          # personal script ID
...
mfrom=attrib-report                              # email sender
email=root                                       # email recipient(s)
log='/var/log/attr-dir-list.log'                 # log name and location (if required)
