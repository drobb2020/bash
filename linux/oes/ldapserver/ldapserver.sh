...
#         USAGE: ./ldapserver.sh 
# 
#   DESCRIPTION: Do an ldap querey to get the current list of OES servers 
...
#   LAST UDATED: Thu Mar 15 2018 10:58
#       VERSION: 0.1.4
#     SCRIPT ID: 072
# SSC SCRIPT ID: 00
#===============================================================================
version=0.1.4                                    # version number of the script
sid=072                                          # personal script ID
